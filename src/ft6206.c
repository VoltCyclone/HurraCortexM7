...
bool ft6206_init(void)
{
	...
	IOMUXC_SW_MUX_CTL_PAD_GPIO_AD_B1_00 = 3; // ALT3
	IOMUXC_SW_MUX_CTL_PAD_GPIO_AD_B1_01 = 3; // ALT3
	uint32_t i2c_pad = IOMUXC_PAD_ODE | IOMUXC_PAD_PKE | IOMUXC_PAD_PUE |
	                   IOMUXC_PAD_PUS(3) | IOMUXC_PAD_HYS |
	                   IOMUXC_PAD_DSE(4) | IOMUXC_PAD_SPEED(1) | IOMUXC_PAD_SRE;
	...
	LPI2C1_MCR = 0;
	LPI2C1_MCCR0 = LPI2C_MCCR0_CLKHI(28) | LPI2C_MCCR0_CLKLO(30) |
	               LPI2C_MCCR0_SETHOLD(14) | LPI2C_MCCR0_DATAVD(8);
	LPI2C1_MCFGR1 = LPI2C_MCFGR1_PRESCALE(0);
	LPI2C1_MFCR = LPI2C_MFCR_TXWATER(0) | LPI2C_MFCR_RXWATER(0);
	LPI2C1_MCR = LPI2C_MCR_MEN;
	uint8_t vendor_id = 0;
	if (!i2c_read_regs(FT_REG_VENDID, &vendor_id, 1)) return false;
	if (vendor_id != 0x11) return false;
	i2c_write_reg(FT_REG_THRESHHOLD, 80);
